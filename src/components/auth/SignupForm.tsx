        ...
        <>
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                <form className="mt-4 space-y-4 lg:mt-5 md:space-y-5" onSubmit={handleSubmit}>
                    ...
                    <div>
                        <AuthInput label="Password" type="password" name="password" id="password" placeholder="••••••••" required />
                    </div>
                    <div>
                        <AuthInput label="Confirm password" type="password" name="confirm-password" id="confirm-password" placeholder="••••••••" required />
                    </div>
                ...
                <SignInWithGoogleButton text="Sign up with Google" handleGoogleSignIn={handleGoogleSignIn} />
            </div>
