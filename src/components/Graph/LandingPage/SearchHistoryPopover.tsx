...
const SearchHistoryRow = ({
  ...
  return (
    <div
      className={clsx(
        "flex flex-row items-center gap-x-2 rounded-lg p-2 transition duration-150 ease-in-out hover:bg-gray-100 hover:text-blue-500 focus:outline-none focus-visible:ring focus-visible:ring-orange-500/50 hover:cursor-pointer",
