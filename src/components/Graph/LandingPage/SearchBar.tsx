    ...
    <div className={clsx("flex rounded-md shadow-sm", className)}>
      <div className="relative flex flex-grow items-stretch focus-within:z-10">
        ...
        <input
          ...
          className={
            "block w-full rounded-none rounded-l-md border-0 py-1.5 pl-10 font-mono text-sm leading-6 text-gray-900 ring-1 ring-inset ring-gray-300 transition-all placeholder:text-gray-400 focus:ring-2 focus:ring-inset" +
