...
import { TutorialCardList, TutorialCardParagraph, TutorialCardTitle, TutorialImage, TutorialVideo } from "../components";
...
const SearchAddressCard: FC = () => {
    return (
        <>
            <TutorialVideo src={SearchAddressVideo} alt="Search Address Demonstration" />
...
const TaggingAddressesCard: FC = () => {
    return (
        <>
            <TutorialVideo src={TaggingAddressesVideo} alt="Tagging Addresses Demonstration" />
...
const AdvancedMenuCard: FC = () => {
    return (
        <>
            <TutorialVideo src={AdvancedMenuVideo} alt="Advanced Menu Demonstration" />
            <TutorialCardTitle title="Advanced Menu" Icon={PresentationChartLineIcon} />
            <TutorialCardParagraph text={"You can access the advanced menu by clicking on the \"Advanced\" button on the top right corner of the address analysis window."} />
        </>
    );
}
...
const ExpandWithAICard: FC = () => {
    return (
        <>
            <TutorialVideo src={ExpandWithAIVideo} alt="Expand With AI Demonstration" />
...
const TransactionsMenuCard: FC = () => {
    return (
        <>
            <TutorialVideo src={TransactionsMenuVideo} alt="Transactions Menu Demonstration" />
            <TutorialCardTitle title="Transactions Menu" Icon={ArrowsRightLeftIcon} />
            <TutorialCardParagraph text={"You can access the transactions menu by clicking on the \"Transactions\" button on the top right corner of the address analysis window."} />
        </>
    );
}
...
const GoodLuckCard: FC = () => {
    return (
        <>
            ...
            <TutorialCardParagraph text="That's it! You're ready to explore the blockchain. Good luck!" />
        </>
    );
};
...
const tutorialSteps = [
    ...
    AdvancedMenuCard,
    ExpandWithAICard,
    TransactionsMenuCard,
    TaggingAddressesCard,
    HotbarCard,
    RiskVisionCard,
    SearchAddressCard,
    ShareGraphCard,
